    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
        ...
        .page { font-family:var(--font-body); color:var(--text); min-height:100vh; display:flex; align-items:center; justify-content:center; padding:24px; position:relative; overflow:hidden; background: radial-gradient(ellipse 80% 60% at 20% 10%,rgba(255,92,26,.07) 0%,transparent 60%), radial-gradient(ellipse 60% 50% at 80% 90%,rgba(120,40,200,.06) 0%,transparent 60%), var(--bg); }
        .stars { position:absolute; inset:0; pointer-events:none; z-index:0; }
        .orbit { position:absolute; border-radius:50%; border:1px solid rgba(255,255,255,.03); pointer-events:none; z-index:0; }
        .orbit-1 { width:500px; height:500px; top:-180px; right:-160px; }
        .orbit-2 { width:320px; height:320px; bottom:-100px; left:-80px; border-color:rgba(255,92,26,.05); }
      ...
      <div className="page">
        ...
        <div className="card-wrap">
          ...
          <h1 className="heading">Gamified</h1>
          <p className="subheading">Level up your learning every day</p>

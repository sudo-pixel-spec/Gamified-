...
exports.seedCurriculumStd8 = seedCurriculumStd8;
...
async function seedCurriculumStd8() {
    const std8 = await Standard_1.Standard.create({ code: "CBSE_STD_8", name: "Std 8", active: true });
    const std9 = await Standard_1.Standard.create({ code: "CBSE_STD_9", name: "Std 9", active: false });
    const std10 = await Standard_1.Standard.create({ code: "CBSE_STD_10", name: "Std 10", active: false });
    ...
    const lessons = await Lesson_1.Lesson.create([
        {
